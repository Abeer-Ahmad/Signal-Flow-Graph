...
public class MasonSolver implements IMasonSolver {
	...
	MasonSolver(ArrayList<ArrayList<String>> forwardPaths, ArrayList<ArrayList<Integer>> forwardGains,
			ArrayList<ArrayList<String>> loops, ArrayList<ArrayList<Integer>> loopGains) {
